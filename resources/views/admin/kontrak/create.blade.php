...
<body>
    ...
    <script>
        function tambahBaris() {
            ...
            row.innerHTML = `
                <button type="button" onclick="this.parentElement.remove()" class="btn-remove" style="background-color: #ef4444; color: white; padding: 5px; border:none; cursor:pointer;">X Hapus</button>
                <div class="grid-2">
                    <div class="form-group"><label>Barang/Uraian Kerja</label><textarea name="uraian[]" rows="2" required></textarea></div>
                    <div class="form-group"><label>Spesifikasi</label><textarea name="spek[]" rows="2" required></textarea></div>
                </div>
